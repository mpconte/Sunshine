...
/**
 * Created by mattconte on 29/10/14.
 */
public class WeatherProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // The code is passed into the constructor represents the code to return for the URI.
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        // Notifies any registered ContentObservers that the URI has changed
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // Notifies any registered ContentObservers that the URI has changed
        // null means we deleted all the rows
        if (selection == null || 0 != numRowsDeleted) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Notifies any registered ContentObservers that rows have been updated
        if (0 != numRowsUpdated){
            getContext().getContentResolver().notifyChange(uri, null);
        }
